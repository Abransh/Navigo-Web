...
function DestinationsPage() {
    return (React.createElement("div", { className: "min-h-screen bg-gray-50" },
        React.createElement("div", { className: "mx-auto max-w-7xl px-4 py-24" },
            ...
            React.createElement("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4" }, allDestinations.map(function (destination) { return (React.createElement("div", { key: destination.name, className: "group flex h-[500px] flex-col overflow-hidden rounded-3xl bg-white p-6 transition-colors hover:bg-[#F3A522]" },
