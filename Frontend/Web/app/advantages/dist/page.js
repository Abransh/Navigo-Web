...
function AdvantagesPage() {
    return (React.createElement("div", { className: "min-h-screen bg-[#FFF3E0] py-24" },
        React.createElement("div", { className: "mx-auto max-w-7xl px-4" },
            React.createElement("div", { className: "rounded-3xl bg-[#F8E3C5] p-12 shadow-lg" },
                React.createElement("div", { className: "grid gap-16 lg:grid-cols-3" },
                    React.createElement("div", null,
                        React.createElement("h1", { className: "text-5xl font-bold leading-tight" },
                            "Benefits we",
                            React.createElement("br", null),
                            "provide")),
                    React.createElement("div", { className: "grid gap-12 lg:col-span-2" },
                        React.createElement("div", { className: "grid gap-12 md:grid-cols-2" },
                            React.createElement("div", null,
                                React.createElement("h2", { className: "mb-4 text-3xl font-medium" }, "Overpricing & scams"),
                                React.createElement("p", { className: "text-gray-700" }, "Being a tourist often means paying more and being targeted by scams. From \"special tourist prices\" to classic tourist traps, it's frustrating to discover you've paid double what locals pay. Let us help you spend wisely and avoid common scams!")),
                            React.createElement("div", null,
