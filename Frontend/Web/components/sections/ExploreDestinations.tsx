...
export default function DestinationsSection() {
  return (
    <section className="mx-auto bg-gray-200 max-w-[1440px] px-4 py-16">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
        {destinations.map((destination) => (
          <Link
            key={destination.name}
            href={destination.href}
            className="group block h-[600px] overflow-hidden rounded-3xl bg-yellow-200 p-6 transition-colors hover:bg-[#F3A522]"
          >
