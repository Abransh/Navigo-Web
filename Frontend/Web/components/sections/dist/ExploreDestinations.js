...
function DestinationsSection() {
    return (React.createElement("section", { className: "mx-auto max-w-[1440px] px-4 py-16" },
        React.createElement("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4" }, destinations.map(function (destination) { return (React.createElement("div", { key: destination.name, className: "group flex h-[500px] flex-col overflow-hidden rounded-3xl bg-gray-50 p-6 transition-colors hover:bg-[#F3A522]" },
            React.createElement("h3", { className: "mb-6 text-center text-2xl font-light" }, destination.name),
