...
var FeatureBoxes = function () {
    ...
    return (react_1["default"].createElement("div", { className: "relative" }, featureBoxes.map(function (feature, index) { return (react_1["default"].createElement("section", { key: index, ref: function (el) { sectionRefs.current[index] = el; }, className: "py-8 opacity-0 translate-y-20 transition-all duration-700 sticky", style: { top: '24vh' } },
        react_1["default"].createElement("div", { className: "max-w-6xl mx-auto flex" },
            react_1["default"].createElement("div", { className: "w-[529px] h-[243px] rounded-2xl bg-[#ECEBE9] p-6 flex flex-col justify-center" },
                react_1["default"].createElement("h3", { className: "text-[28px] font-bold mb-4" }, feature.title),
                react_1["default"].createElement("p", { className: "text-base" }, feature.description)),
            react_1["default"].createElement("div", { className: "w-[81px] h-[243px] rounded-2xl mx-1 overflow-hidden" },
            ...
            react_1["default"].createElement("div", { className: "w-[448px] h-[243px] rounded-2xl overflow-hidden" },
                react_1["default"].createElement("div", { className: "w-full h-full relative" },
