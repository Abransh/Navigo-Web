...
var Header = function () {
    ...
    return (react_1["default"].createElement("div", { className: "fixed top-4 left-0 right-0 z-50 transition-transform duration-300 px-2 " + (visible ? 'translate-y-0' : '-translate-y-full') },
        react_1["default"].createElement("header", { className: "flex justify-between items-center py-3 max-w-7xl mx-auto" },
            ...
            react_1["default"].createElement("div", { className: "w-[249px] h-[32px] bg-white/80 backdrop-blur-sm rounded-full shadow-md flex items-center px-6 justify-between group hover:bg-[#6babea] transition-all duration-300" },
                react_1["default"].createElement(link_1["default"], { href: "/trip-planner", className: "text-sm group-hover:text-white transition-colors duration-300" }, "Plan Your Trip"),
