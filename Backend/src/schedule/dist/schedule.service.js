...
var ScheduleService = /** @class */ (function () {
    function ScheduleService(bookingsService, emailService, notificationsService) {
    ...
    ScheduleService.prototype.handleDailyTasks = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sendUpcomingBookingReminders()];
                    case 1:
                        // Send booking reminders for upcoming bookings (within next 24 hours)
                        _a.sent();
                        // Clean up expired database records
                        return [4 /*yield*/, this.cleanupExpiredRecords()];
                    case 2:
                        // Clean up expired database records
                        _a.sent();
                        return [2 /*return*/];
    ...
    ScheduleService.prototype.handleHourlyTasks = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.updateBookingStatuses()];
                    case 1:
                        // Update booking statuses (e.g., mark as completed if end time has passed)
                        _a.sent();
                        return [2 /*return*/];
    ...
    ScheduleService.prototype.sendUpcomingBookingReminders = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    ScheduleService.prototype.updateBookingStatuses = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    ScheduleService.prototype.cleanupExpiredRecords = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    ], ScheduleService.prototype, "handleDailyTasks");
    __decorate([
        schedule_1.Cron(schedule_1.CronExpression.EVERY_HOUR)
    ], ScheduleService.prototype, "handleHourlyTasks");
