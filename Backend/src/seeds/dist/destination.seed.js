...
var destination_entity_1 = require("../destinations/entities/destination.entity");
var typeorm_1 = require("typeorm");
exports.seedDestinations = function () { return __awaiter(void 0, void 0, void 0, function () {
    var destinationRepository, count, destinations, _i, destinations_1, destination;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                destinationRepository = typeorm_1.getRepository(destination_entity_1.Destination);
                return [4 /*yield*/, destinationRepository.count()];
            case 1:
                count = _a.sent();
                if (count > 0) {
